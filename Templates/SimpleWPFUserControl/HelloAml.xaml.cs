...
namespace AMLEditorPlugin
{
    ...
    public partial class HelloAml : UserControl, IAMLEditorView
    {
        ...
        /// <summary>
        /// Gets a value indicating whether this instance is readonly. No CAEX Objects will be
        /// modified by the Plugin. If a Plugin is Readonly, the AmlEditor is enabled. If a Plugin
